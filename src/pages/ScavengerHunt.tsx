        ...
        <div className="w-full max-w-md text-center">
          ...
          <Card className="backdrop-blur-sm bg-black/20 border-white/20 animate-scale-in">
            <CardHeader>
              ...
              <CardDescription className="text-white/90">
                {hunt.congratulations_message || "You've successfully completed the scavenger hunt! Your name will be entered into a drawing for an AUMOVIO cooler bag and you will be contacted by MarComm if you're one of the ten lucky winners!"}
              </CardDescription>
            </CardHeader>
            <CardContent>
